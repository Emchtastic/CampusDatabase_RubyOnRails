...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { Semester: "Fall", Year: 1998, course_id: @section.course_id } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { Semester: "Spring", Year: 1999, course_id: @section.course_id } }
